...
- et la partie `home/users/default.nix` pour l'utilisateur defini dans `vars.nix`
...
- ajouter un dotfile dans `dotfiles/` + `home/users/default.nix`
...
- met a jour les symlinks de `home/users/default.nix`
...
2. verifier que `home/users/default.nix` reference bien ce fichier
3. appliquer :
