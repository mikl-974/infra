...
- et la partie `home/default.nix` pour l'utilisateur defini dans `vars.nix`
...
- met a jour les symlinks de `home/default.nix`
...
2. verifier que `home/default.nix` reference bien ce fichier
3. appliquer :
